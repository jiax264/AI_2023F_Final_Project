...
plt.legend()
plt.savefig('loss_ensemble_mlp_2hidden_64_64_300epoch_500batch_001lr_weight_decay_1e-5.png')
...
plt.legend()
plt.savefig('accuracy_ensemble_mlp_2hidden_64_64_300epoch_500batch_001lr_weight_decay_1e-5.png')
...
plt.savefig('cm_val_ensemble_mlp_2hidden_64_64_300epoch_500batch_001lr_weight_decay_1e-5.png')
...
plt.ylabel('True label')
plt.xlabel('Predicted label')
plt.savefig('cm_test_ensemble_mlp_2hidden_64_64_300epoch_500batch_001lr_weight_decay_1e-5.png')
...
precision_macro_test, recall_macro_test, f1_score_macro_test, _ = precision_recall_fscore_support(y_test_true, y_test_pred, average='macro')
precision_micro_test, recall_micro_test, f1_score_micro_test, _ = precision_recall_fscore_support(y_test_true, y_test_pred, average='micro')
